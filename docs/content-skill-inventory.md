...
| 3 | WildAura | 5 | dmg 10 +2.4/L @40t, r1.4 +.05/L | Drop PG: SaberToothCat .2, AngryMammoth 1.0 — **world-unreachable** |
...
| 7 | ReaperAura | 3 | dmg 12 +3/L @40t r2.0; execute <35% ×2; crit 25% ×2; lifesteal 50%; berserker | NPC-PG Sage @L10 — **world-unreachable** |
...
| 45 | LongRangeStrike | 5 | dmg 9 +2/L, r2.6 +.1/L | Drop: EliteWolf .5 |
...
| ID | Name | MaxLv | Values | Source |
|---|---|---|---|---|
| 10 | SwiftPassive | 3 | move speed +5% +5%/L | Drop: Wolf .15 |
...
| 21 | Heal | 3 | self-heal 20% +5%/L of max; CD 900 | MS L2 |
...
| 31 | Recover | 1 | instant HoT 4 (9×60t) self+allies, r2; CD 1200 | MS L3 |
...
| 34 | Haste | 1 | tick rate ×0.5 for 90t; CD 300 | MS L4 |
...
- **Source exists only in proving-grounds, 5:** WildAura, SlowAura,
  ToughPassive (drops), Revive, ReaperAura (Sage teachings).
