...
- **plan-faction-flips.md** — **runtime allegiance** (planned 2026-07-28; **all 3 chunks shipped**: the seam `ec73634e`, calm `216f733b`, charm `153c0032`). Closed `plan-entity-model.md` L2 by replacing one undefined setter with three defined verbs, then shipped **calm** and **charm** on top of it. Stays live for its §8 open questions — nothing it shipped is reachable without the `SKILL` cheat, and a charmed mob's survival in a pack is an open PO tuning call
