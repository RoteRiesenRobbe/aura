...
| Wildfire | in-game *(C7)* | Fire gap fill @ ~70% side-grade: Immolate-style fire dot on 2 targets, each burn weaker than Immolate's. | Combination result — `content-recipes.md`. `api/skills/wildfire.json`. |
