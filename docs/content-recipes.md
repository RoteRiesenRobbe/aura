...
| Wildfire | in-game *(C7)* | Ignite(3) + Immolate(5) | The fire capstone — reworked 2026-07-21 off the ~70% calibration into a strict Immolate upgrade: full-strength burn on 2 targets, bigger radius, one extra tick, caster-only fire resist. |
...
CallForAid, DamageBurst, Taunt, Ignite, Immolate, Slow,
LongRangeStrike, Hardy, Tough, Paladin, Barrier + the 8 C7
results.

**⚑ Ingredient placement gap — RESOLVED (C8 §11 placements, 2026-07-21).**
Ignite/Immolate (Emberkeeper), Slow (BanditRanged) and Tough (Troll) all
