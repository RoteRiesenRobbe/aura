...
| Dire wolf | in-game *(intermission ②)* | Animal / normal | Z2 wildlife step-up, apex of the Session-④ predator forest; WolfBite, curveLevel 6. Drops WildAura @0.06 + KeenEye @0.06. **Own sprite since the unique-art pass (2026-07-21)** — was a Wolf reskin. `api/mobs/dire-wolf.json`. |
...
| Alpha wolf | in-game *(farm-band pre-chunk)* | Animal / normal | **cL8-17 farm band** (2026-07-21): apex of the wolf line (Wolf 2 → DireWolf 6 → Alpha 10); WolfBite, speed 0.74 under the PO normal ceiling (guardrail-soft). XP 275 (kph-derived, facetank). Own sprite. No drops yet. PO places spawns. `api/mobs/alpha-wolf.json`. |
