...
| Elite wolf | in-game *(C2)* | Animal / elite | Dark-forest pack leader ("something big"); EliteWolfBite carries **execute + lifesteal** (feeds on wounded prey). Guards the Hermit approach. Drops Swift @0.1 + KeenEye @0.06 (line-wide) + WildAura @0.5. `api/mobs/elite-wolf.json`. |
...
| Dire wolf | in-game *(intermission ②)* | Animal / normal | Z2 wildlife step-up, apex of the Session-④ predator forest; WolfBite, curveLevel 6. Drops Swift @0.1 + KeenEye @0.06 (line-wide) + LongRangeStrike @0.2. **Own sprite since the unique-art pass (2026-07-21)** — was a Wolf reskin. `api/mobs/dire-wolf.json`. |
| Dire bear | in-game *(intermission ②)* | Animal / normal | Z2 tank half of the wildlife step-up; BearSwipe, curveLevel 7 — the Z2 band's hard normal. Drops Recover @0.02. **Own sprite since the unique-art pass (2026-07-21)** — was a Bear reskin. `api/mobs/dire-bear.json`. |
