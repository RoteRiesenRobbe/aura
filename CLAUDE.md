...
- **Next:** Block 2 (survival removal + resource unification, roadmap items 1+2) or Phase 7 (skill leveling + skill points; includes writing the full combinations design). Roadmap: docs/v1-roadmap.md.
