...
- **Open code-health findings** (documented 2026-07-24, none scheduled — `docs/backlog.md` §27 / `docs/research-code-quality.md` §10):
  ...
  - ③ `skills/definition.go` guard coverage is uneven — loads 0-damage/0-heal/0-radius auras and `mapToEffectDef` has no `default:` (nil payload pointers), violating its own doc-comment invariant (one-line fix; §27).
