...
- **Three plans designed 2026-08-12/11, execution open:** `plan-code-health.md` (C1-C2 ✅; **C3-C7 open** — C3/C7 independent, C4 before C6) · `plan-zone-editor-structure.md` (C1-C3: `kindOf` structure → controls + the talker round-trip that fixes the uneditable ascension stones → retire the legacy roster) · `plan-play-bot.md` (C0-C3: extract transport → the bot that fights → quests → the soak finding).
