...
- **One plan in flight: `plan-effect-types.md`** (round 1, schema NONE all four chunks) - C1 vulnerability ✅ 2026-08-16 · C2 retaliate damage + Retribution ✅ 2026-08-17 · C3 invulnerability + follow-ups ✅ 2026-08-17; open: **C4 ally speed** (next, the LAST chunk - archive the plan when it lands). Untouched: `plan-play-bot.md` (C0-C3) · `plan-prototype-projectile.md` (designed 2026-08-15). ⚑ Zone-editor C3 leftovers, owned by nobody: the Go legacy plumbing is now dead code (Legacy/LegacyRefs fields + the unreachable loaders warning) · `wiki-generator/` is broken at HEAD independently of C3 (requires the §28-deleted `client-data/Items`).
