...
// chunk 3): a circle body + a client sprite picked by EntityType + the
// blocksMovement flag. Props are built once from the authored zone at boot;
// they route through game.AddEntity's plain model.Entity case (static body +
// net streaming) and marshal through the Resource wire table — no harvest,
// decay, respawn or update systems involved.
package prop
