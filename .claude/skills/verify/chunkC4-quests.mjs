...
await joinAsNewCharacter(page, 'quest');
...
try {
  ...
  // Q4 retired the Damage teaching (creation milestone); R4 C1 moved Recall to
  // a baseline utility and removed its teaching (plan-downtime.md D7/D8) — so the crier teaches nothing
